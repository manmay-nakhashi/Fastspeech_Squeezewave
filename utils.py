...
def get_squeezewave():
    squeezewave_path = os.path.join("squeezewave", "pretrained_model")
    squeezewave_path = os.path.join(squeezewave_path, "L128_large_pretrain")
    wave_glow = torch.load(squeezewave_path, map_location=device)['model']
